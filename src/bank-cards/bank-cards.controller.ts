...
@ApiTags('Bank Cards (Agency Panel - General Manager Only)')
...
export class BankCardsController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get all bank cards for this agency' })
  ...
  @Patch(':cardId')
  @ApiOperation({ summary: 'Update a bank card' })
  ...
  @ApiOperation({ summary: 'Activate or deactivate a bank card' })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Set a bank card as default' })
  ...
  @Delete(':cardId')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Delete a bank card (only if not used in invoices/payments)' })
